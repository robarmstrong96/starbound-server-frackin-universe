...
# Run a container
docker run -p 0.0.0.0:21025:21025/tcp --env-file .env -v "$(pwd)/starbound_data:/steamcmd/starbound" --name starbound-server -it --rm robstrong/starbound-server-frackin-universe:latest
